...
var UploadImages = function (_a) {
    ...
    var imageUploadInputRef = React.useRef(null);
    var _e = React.useState(false), isDragging = _e[0], setDraggingStatus = _e[1];
    ...
    return (React__default['default'].createElement("div", { className: styles.container },
        React__default['default'].createElement("div", { className: styles.uploadImages + " " + (isDragging ? styles.dragging : ""), onClick: onClickUploadImages, onDragEnter: onDragEnter, onDragLeave: onDragLeave, onDragOver: onDragOver, onDrop: onDrop },
            ...
            multiple ?
                React__default['default'].createElement("input", { ref: imageUploadInputRef, className: styles.imageInput, onChange: function (e) {
        ...
        currentImages.length > 0 && (React__default['default'].createElement("div", { className: styles.uploadedImages }, currentImages.map(function (ui) {
            var _a;
            return (React__default['default'].createElement("div", { key: Math.random() * 8888 + "custom-react-uploader", className: styles.image },
                React__default['default'].createElement("div", { className: styles.deleteImageIcon, onClick: function () { return removeUploadImage(ui); } },
